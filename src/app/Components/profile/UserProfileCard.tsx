...
type UserProfileCardProps = {
  ...
  profileCompletion: number; // in percentage
...
export default function UserProfileCard({
  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 sm:px-8 w-[80%] mx-auto">
      {/* Profile Section */}
      ...
      <div className="mt-4 sm:mt-0 sm:ml-8">
        <label className="text-sm font-extrabold mr-2">
          Relationship Type:
        </label>
        <select
          value={relationshipType}
          onChange={(e) => onRelationshipTypeChange?.(e.target.value)}
          className="bg-white rounded-lg px-2 text-sm drop-shadow-md focus:outline-none focus:ring-0"
        >
